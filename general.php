...
class dbase{
	...
	function connect_sqlite() {
		...
		if ($d==0)
		{
			$this->executeSQL('CREATE TABLE "codes" ("NodeID" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "NodeName" TEXT, "IsFolder" INTEGER, "ParentNode" INTEGER, "NodeCode" TEXT);', null);
